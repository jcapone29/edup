...
.controller('drawerCtrl', ['$rootScope', '$element', '$attrs', '$ionicGesture', '$ionicScrollDelegate', '$timeout', '$document', function ($rootScope, $element, $attr, $ionicGesture, $ionicScrollDelegate, $timeout, $document) {
